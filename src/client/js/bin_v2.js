 ...
 * @constructor
 */
binMaster.Bin_Range = function (opt_minVal, opt_maxVal, opt_colorVal) {
	this.binType = 'range';
...
binMaster.Bin_Single = function(opt_val, opt_colorVal){
	this.binType = 'single';
	this.setEncodingDefn(opt_colorVal);
	this.labelVals = {}; // label is only for a single value...
}
 ...
 */ 
binMaster.Bin_Range.prototype.setNumericDefn = function(opt_minVal, opt_maxVal){
	this.binVals = {
...
binMaster.Bin_Single.prototype.setNumericDefn = function(opt_val){
	this.binVal = optVal;
}
 ...
 */ 
binMaster.Bin_Range.prototype.setEncodingDefn = function(opt_colorVal){
...
binMaster.Bin_Single.prototype.setEncodingDefn = function(opt_colorVal){
	this.setColor(opt_colorVal);
}
 ...
 */
binMaster.Bin_Range.prototype.setLabelDefn = function(labelName, rangeVal, minVal, maxVal){
 ...
 */ 
binMaster.Bin_Range.prototype.setBinMin = function(val){
...
binMaster.Bin_Range.prototype.getBinMin = function(){
	return this.binVals.min;
}
 ...
 */ 
binMaster.Bin_Range.prototype.setBinMax = function(val){
...
binMaster.Bin_Range.prototype.getBinMax = function(){
	return this.binVals.max;
}

binMaster.Bin_Range.prototype.getBinRange = function(){
 ...
 */ 
binMaster.Bin_Range.prototype.setColor = function(colorVal){
 ...
 */ 
binMaster.Bin_Range.prototype.getColor = function(opt_format){
 ...
 */ 
binMaster.Bin_Range.prototype.setLabelMin = function(minVal, opt_labelName){
	var labelName;
 ...
 * @return {string} 
 */ 
binMaster.Bin_Range.prototype.getLabelMin = function(labelName){
	var labelname;
 ...
 * @param {string} opt_labelName - optional label name.  If label name is undefined, set to DEFAULT, otherwise creates it
 */ 
binMaster.Bin_Range.prototype.setLabelMax = function(maxVal, opt_labelName){
	var labelName;
	labelName = this._getLabelName(opt_labelName);
 ...
 * @return {string} 
 */ 
binMaster.Bin_Range.prototype.getLabelMax = function(labelName){
	var labelname;
	labelName = this._getLabelName(labelName);
 ...
 * @param {string} opt_labelName - optional label name.  If label name is undefined, set to DEFAULT, otherwise creates it
 */ 
binMaster.Bin_Range.prototype.setLabelRange = function(rangeVal, opt_labelName){
	var labelName;
	labelName = this._getLabelName(opt_labelName);
 ...
 * @return {string} 
 */ 
binMaster.Bin_Range.prototype.getLabelRange = function(labelName){
	var labelname;
	labelName = this._getLabelName(labelName);
...
binMaster.Bin_Range.prototype._getLabelName = function(labelName){
...
binMaster.Bin_Range.prototype.printBinLabel = function(labelName){
