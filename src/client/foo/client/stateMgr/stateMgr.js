/**
 * @fileoverview stateMgr.js provides access/an interface to the (csv) data.
 */
'use strict';
 ...
 * @constructor
 */
eviza.StateMgr = function (dataPath, cb) {
 ...
 * load a data file
 */
eviza.StateMgr.prototype.load = function (dataPath, opt_cb) {
 ...
 * be expensive.
 */
eviza.StateMgr.prototype._recomputeRowsAndColumns = function (obj) {
  this.colCount = 0;
  this.rowCount = 0;
  this.columnNameList = [];
 ...
 */
eviza.StateMgr.prototype._fixObj = function (obj) {
  for (var prop in obj) {
 ...
 */
eviza.StateMgr.prototype.getColumnNames = function () {
 ...
 */
eviza.StateMgr.prototype.getRowCount = function () {
 ...
 */
eviza.StateMgr.prototype.getColumnCount = function () {
  return this.colCount;
};


/**
 * @return access to the indexth row in the stateMgr.
 */
eviza.StateMgr.prototype.getRowByIndex = function (index) {
 ...
 */
eviza.StateMgr.prototype.getRows = function (matchFn) {
  var resultList = [];
 ...
 */
eviza.StateMgr.prototype.getColumn = function (columnName) {
  var resultList = [];
 ...
 */
eviza.StateMgr.prototype.setSelected = function (obj, value) {
 ...
 */
eviza.StateMgr.prototype.isSelected = function (obj) {
 ...
 */
eviza.StateMgr.prototype.clearAllSelected = function () {
 ...
 */
eviza.StateMgr.prototype.getAllSelected = function () {
  var resultList = [];
  for (var i = 0; i < this.rowCount; ++i) {
