 ...
 * @constructor
 */
xp3.DataMgr = function (dataPath, cb) {
 ...
 * load a data file
 */
xp3.DataMgr.prototype.load = function (dataPath, opt_cb) {
 ...
 * be expensive.
 */
xp3.DataMgr.prototype._recomputeRowsAndColumns = function () {
  this.colCount = 0;
  this.rowCount = 0;
  this.columnNameList = [];
 ...
 */
xp3.DataMgr.prototype._fixObj = function (obj) {
  for (var prop in obj) {
 ...
 */
xp3.DataMgr.prototype.getColumnNames = function () {
 ...
 */
xp3.DataMgr.prototype.getRowCount = function () {
 ...
 */
xp3.DataMgr.prototype.getColumnCount = function () {
 ...
 */
xp3.DataMgr.prototype.getRowByIndex = function (index) {
 ...
 */
xp3.DataMgr.prototype.getRows = function (matchFn) {
  var resultList = [];
 ...
 */
xp3.DataMgr.prototype.getColumn = function (columnName) {
  var resultList = [];
 ...
 */
xp3.DataMgr.prototype.setSelected = function (obj, value) {
 ...
 */
xp3.DataMgr.prototype.isSelected = function (obj) {
 ...
 */
xp3.DataMgr.prototype.clearAllSelected = function () {
 ...
 */
xp3.DataMgr.prototype.getAllSelected = function () {
  var resultList = [];
  for (var i = 0; i < this.rowCount; ++i) {
